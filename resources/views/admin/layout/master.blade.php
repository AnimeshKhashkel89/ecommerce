            ...
            <div class="nav-link">
              <div class="user-wrapper">
                ...
                <div class="text-wrapper">
                  <p class="profile-name">Animesh Khashkel</p>
                  <div>
              ...
              <button class="btn btn-success btn-block">Connect
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{!! route('admin.product.manage') !!}">Manage Product</a>
                </li>
              </ul>
            </div>
          </li>
